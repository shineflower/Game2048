...
public class ConfigPreference extends Activity implements OnClickListener {
    ...
    private void initView() {
        ...
        mBtnGameLines.setText("" + Config.mSharedPreferences.getInt(Config.KEY_GAME_LINES, 4));
        mBtnGoal.setText("" + Config.mSharedPreferences.getInt(Config.KEY_GAME_GOAL, 2048));
    ...
    private void saveConfig() {
        Editor editor = Config.mSharedPreferences.edit();
